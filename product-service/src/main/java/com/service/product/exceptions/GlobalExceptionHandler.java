...
import com.service.product.responses.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAmqpException(AmqpException ex) {
        Map<String, String> errors = new HashMap<>();
        errors.put("rabbitmq_error", ex.getMessage());

        ErrorResponse errorResponse = new ErrorResponse(500, "RabbitMQ Error", errors);
