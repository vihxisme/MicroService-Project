...
public class RabbitConfig {
    ...
    @Value("${rabbitmq.exchange.api-composition}")
    ...
    public DirectExchange cacheExchange() {
        return new DirectExchange("cache-update.exchange");
    }
    ...
    @Bean
    public Binding bindingCacheQueue(Queue cacheQueue, DirectExchange cacheExchange) {
        return BindingBuilder.bind(cacheQueue).to(cacheExchange).with("clear-cache");
    }
}
